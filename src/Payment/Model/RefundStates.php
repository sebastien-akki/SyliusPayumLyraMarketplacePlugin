 ...
 */
final class RefundStates
{
    public const STATE_CREATED         = 'refund_pending';
    public const STATE_PENDING         = 'refund_pending';
    public const STATE_CANCELLED       = 'refund_cancelled';
    public const STATE_FAILED          = 'refund_failed';
    public const STATE_ABANDONED       = 'refund_failed';
